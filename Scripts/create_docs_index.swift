    ...
    <div class="hero">
        <div class="container">
            ...
            <div class="buttons">
                ...
                <a href="https://github.com/your-username/AnthropicKit" class="button secondary">GitHub</a>
            </div>
        </div>
    </div>
...
<span class="code-keyword">print</span>(message.<span class="code-property">content</span>.<span class="code-property">first</span>?.<span class="code-property">text</span> ?? <span class="code-string">""</span>)</code></pre>
    ...
    <footer class="footer">
        <div class="container">
            <p>Built with ❤️ for the Swift community</p>
            <p style="margin-top: 10px;">
                ...
                <a href="https://github.com/your-username/AnthropicKit">GitHub</a>
            </p>
        </div>
    </footer>
</body>
